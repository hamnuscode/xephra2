...
Welcome to Rival — a gaming platform where users join events, chat in groups and privately with admins, view rankings, and participate in a competitive gaming community. We value your trust and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, share, and protect your information when you use our website and services.
  ...
  Rival includes group chats for events and one-on-one messaging between users and admins. These chats are stored securely and may be monitored by admins:
  ...
  Rival admins are responsible for maintaining the integrity of the platform. Admins may access user data (including chats and event history) for:
  ...
  Rival offers paid features and event participation options. All payment transactions are handled securely by trusted third-party processors (e.g., Stripe, PayPal).
  ...
  To Protect Rival: When necessary to enforce our Terms or protect our rights, users, and community.
  ...
  Rival is not designed for children under the age of 13. If we learn that we have collected personal data from a child without parental consent, we will delete it promptly.
  
  12. International Users
  If you are accessing Rival from outside your home country, be aware that your data may be transferred to and processed in other countries where our servers or service providers are located.
  
  13. Changes to This Policy
  We may update this Privacy Policy from time to time. We will notify you of any significant changes via email or through the website. Continued use of Rival after changes indicates your acceptance of the new terms.
...
At Rival, we strive to ensure that our users have a positive experience. However, due to the nature of our digital services, certain conditions apply to our refund policy. Please read the following refund policy carefully before making any purchases on our website.

1. Subscription-Based Services
Rival offers subscription plans to access premium features, exclusive events, and other functionalities. Subscriptions are charged on a recurring basis, either monthly or annually, depending on the plan you choose.
...
2. Event Fees
In certain cases, Rival may charge a fee to participate in specific gaming events. These fees are non-refundable under any circumstances, including but not limited to:
...
3. Chargebacks
If a user initiates a chargeback through their payment provider, Rival reserves the right to suspend or ban the user's account immediately. All chargeback claims will be investigated, and we may take legal action if necessary to recover any funds lost due to fraudulent chargebacks.
...
Technical Issues: If a user is unable to access their purchased subscription or event due to technical issues caused by Rival's servers (not user-related), a refund may be issued at the discretion of Rival's support team.
...
Rival reserves the right to modify or update this Refund Policy at any time. Any changes will be posted on this page, and the updated policy will become effective immediately upon posting. We encourage you to review this policy periodically for any updates.
...
Address:Al Ghurair Giga Westria road, Plaza No #34 2nd Floor, DHA phase 2, Islamabad
  Phone Number: +92-300-0692222, +92 339 0018363`,
    ...
    service: `Service Policy for Rival Website

At Rival, we are dedicated to delivering a high-quality, engaging, and fair gaming experience for all our users. Our service policy outlines the terms and conditions under which our website and services are provided. By accessing or using Rival, you agree to comply with these terms.
...
Account Security: You are responsible for maintaining the confidentiality of your account credentials. Rival is not liable for any unauthorized access to your account.
...
Event Cancellations: Rival reserves the right to cancel or reschedule events due to technical difficulties, insufficient participation, or other unforeseen circumstances. Users will be notified of event changes, and refunds will be issued where applicable (see our Return Policy).
...
Accuracy of Rankings: While we strive to provide accurate and up-to-date rankings, Rival cannot guarantee the accuracy of every rank or event result. If you believe there has been an error, please contact our support team.

4. Subscription and Payments
Subscription Plans: Rival offers subscription plans that grant users access to exclusive content, events, and features. Subscription fees are billed according to the plan selected.
...
6. Content Usage
Intellectual Property: All content provided on Rival, including images, logos, and event-related materials, are owned by Rival or its licensors. Users are not permitted to reproduce, distribute, or use this content without permission.

User-Generated Content: By submitting content (e.g., profile pictures, chat messages, etc.) to the website, you grant Rival a non-exclusive, royalty-free license to use, display, and distribute the content on the platform.

7. Service Availability
Platform Stability: Rival strives to provide continuous service and maintain the platform's uptime. However, occasional maintenance, updates, or unexpected technical issues may lead to temporary interruptions.

Service Modifications: Rival reserves the right to modify, update, or discontinue any part of the platform, services, or features without prior notice.

8. Privacy and Data Protection
Personal Information: Rival respects your privacy and is committed to protecting your personal data. For more details, please review our Privacy Policy.
...
By using Rival, you agree to abide by this Service Policy, as well as any other terms or guidelines provided. We reserve the right to update this policy at any time, and you will be notified of any changes.`,

    return: `Return Policy for Rival Website

At Rival, we strive to provide the best gaming experience for all of our users. We understand that sometimes things don't go as planned, so we've created the following return policy to ensure your satisfaction.
...
Event Cancellation: If an event you registered for is canceled by Rival, you are eligible for a full refund for the entry fee, if applicable.
...
Payments for subscriptions, events, and other services are processed through secure payment gateways. Rival is not responsible for third-party transaction errors.

5. Profile and Ranking
User profiles, rankings, and event participation are subject to Rival's terms of service. Rankings reflect your performance in events, and these cannot be reset or altered unless there is a verified issue.`,

    terms: `Terms and Conditions

Effective Date: [April 2025]

Welcome to Rival! Please read the following terms and conditions carefully before using our website and services. By accessing or using our website, you agree to be bound by these terms and conditions. If you do not agree, please do not use the website.

1. Acceptance of Terms
By accessing or using the Rival website, you agree to comply with and be bound by these Terms and Conditions. These terms may be updated from time to time, and we encourage you to review them periodically.

2. User Account
To participate in events, use our chat feature, and access other services, you must create an account on the Rival website. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You agree to provide accurate and up-to-date information when creating your account.

3. Events and Rankings
Rival offers various gaming events where users can participate and be ranked based on their performance. Rankings will be displayed publicly on the website. Users are required to play fairly and follow all event rules. Any attempt to manipulate rankings or cheat in events will result in suspension or termination of the user's account.
...
Rival reserves the right to suspend or ban any user who violates these terms.
...
Rival offers payment subscriptions for users to access premium features, including exclusive events or additional functionalities. By subscribing, you agree to pay the subscription fees as outlined on our website. Payments will be processed securely, and users are responsible for ensuring that their payment information is up to date.

Subscriptions are non-refundable, and users can cancel their subscription at any time before the next billing cycle.

8. Privacy and Data Collection
Rival respects your privacy. We collect and process personal data in accordance with our Privacy Policy. By using the website, you consent to the collection and use of your data as outlined in the Privacy Policy.

9. Cheating and Suspension
Users found cheating, exploiting bugs, or engaging in any fraudulent activity will be immediately suspended or banned. The decision to suspend or ban a user is at the sole discretion of Rival's administrative team.

10. Limitation of Liability
Rival is not liable for any damages, losses, or expenses arising from your use of the website or participation in any events, including any indirect, incidental, or consequential damages.

11. Indemnification
You agree to indemnify, defend, and hold harmless Rival, its officers, employees, and agents from any claims, liabilities, damages, or costs arising from your breach of these Terms and Conditions or your use of the website.

12. Changes to Terms
Rival reserves the right to modify or update these Terms and Conditions at any time. Any changes will be posted on this page, and the updated Terms will become effective immediately upon posting.
    ...
    <footer style={{ background: "rgba(5, 7, 20, 0.95)", borderTop: "1px solid rgba(75, 85, 99, 0.2)" }}>
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          {/* Brand */}
          <div>
            <img src={logo} alt="RIVAL Logo" className="h-8 w-auto mb-5" />
            ...
            <div className="flex gap-3">
              {[
                { Icon: Facebook, href: "https://www.instagram.com/rival.official/" },
                { Icon: Twitter, href: "https://www.instagram.com/rival.official/" },
                { Icon: Instagram, href: "https://www.instagram.com/rival.official/" },
                { Icon: Youtube, href: "https://www.instagram.com/rival.official/" },
                { Icon: Twitch, href: "https://www.instagram.com/rival.official/" },
              ].map(({ Icon, href }, i) => (
                <a
                  key={i}
                  href={href}
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                { Icon: Mail, text: "officialrival@gmail.com" },
        ...
        >
          <p className="text-xs" style={{ color: "#4B5563", fontFamily: "Inter, sans-serif" }}>
            © 2025 RIVAL. All rights reserved. Developed by TechxServe for gamers.
          </p>
